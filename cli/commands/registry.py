...
class CommandRegistry:
    ...
    def _register_builtin_commands(self):
        ...
        self.register("help", self._cmd_help, "Show available commands", "/help [command]", aliases=["h", "?"])
        self.register("models", self._cmd_models, "Switch AI Model", "/models", aliases=["model", "ai"])
